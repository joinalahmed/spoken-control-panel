...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Fetching knowledge base items for user', user.id)
    ...
    console.log('Knowledge base items fetched successfully:', data)
    ...
    console.error('Error in list-knowledge-base function:', error)
    return new Response(
